 ...
 * showing the reference to it. If not made properly, the published object can
 * be in an inconsistent state due to the Java Memory Model.
 * 
 ...
 * example, we're using static fields, but AtomicReference and Volatile can also
 * an option.
 * 
